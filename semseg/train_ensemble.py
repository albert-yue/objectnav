...
def build_parser():
    ...
    parser.add_argument('--data-dir', default='data/semseg/frames/', metavar='DIR',
    ...
    parser.add_argument('--summary-dir', default='./semseg/summary/ensemble/', metavar='DIR',
                        help='path to save summary')
    parser.add_argument('--ckpt-dir', default='./semseg/checkpoints/ensemble/', metavar='DIR',
