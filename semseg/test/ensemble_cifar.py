...
def build_parser():
    ...
    parser.add_argument('--data-dir', default='data/', metavar='DIR',
                        help='path to CIFAR dataset - should be directory that contains cifar data') 
    ...
    parser.add_argument('--summary-dir', default='./semseg/summary/cifar-ensemble/', metavar='DIR',
                        help='path to save summary')
    parser.add_argument('--ckpt-dir', default='./semseg/checkpoints/cifar-ensemble/', metavar='DIR',
...
if __name__ == '__main__':
    ...
    train_data = CIFAR10(args.data_dir, train=True, transform=transform, download=True)
